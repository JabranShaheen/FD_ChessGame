...
namespace FD_ChessGame.Tests
{
    ...
    public class PlayerTests
    {
        ...
        public void Player_Can_Move_Down()
        {
            ...
            // Assert
            Assert.AreEqual(1, position.Row);  // Move down should return to the original row
            Assert.AreEqual(1, position.Column); // No change in column
        }
        ...
        public void Player_Can_Move_Left()
        {
            ...
            // Assert
            Assert.AreEqual(1, position.Row);  // No change in row
